...
class GithubRepositoryTest < Minitest::Test
  def setup
    ...
    @github_repository = GithubRepository.new(pull_request_downloader: @pull_request_downloader_mock)
  end
  ...
  def test_no_pull_request
    ...
    @pull_request_downloader_mock.expect(:download, '', [owner: owner, repository: repository])
